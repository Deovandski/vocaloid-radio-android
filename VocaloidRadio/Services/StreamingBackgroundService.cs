...
namespace VocaloidRadio.Services
{
    [Service]
    ...
    public class StreamingBackgroundService : Service, AudioManager.IOnAudioFocusChangeListener
    {
		...
		private const string Mp3 = @"http://curiosity.shoutca.st:8019/128";
		...
		private void UpdateMetadata()
		{
			...
			metadataEditor.PutString (MetadataKey.Album, "Radio Stream 24/7");
			metadataEditor.PutString (MetadataKey.Title, "Vocaloid Radio");
        ...
        private void IntializePlayer()
        {
            ...
            //Tell our player to steam music
        ...
        private void StartForeground()
        {
			...
			{
				TickerText = new Java.Lang.String("Stream is ready!"),
				Icon = Resource.Drawable.ic_stat_av_play_over_video
			};
			notification.Flags |= NotificationFlags.OngoingEvent;
				notification = new Notification.Builder(ApplicationContext)
					.SetContentTitle("Vocaloid Radio")
					.SetContentText("Streaming at 128kbps!")
